...
def upgrade():
    ...
    op.create_foreign_key(None, 'item', 'lab', ['lab_id'], ['id'], ondelete='CASCADE')

    # Update Lab table to use cascade delete for owner_id
    op.drop_constraint('lab_owner_id_fkey', 'lab', type_='foreignkey')
    op.create_foreign_key(None, 'lab', 'user', ['owner_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key(None, 'user_lab', 'user', ['user_id'], ['id'], ondelete='CASCADE')
    op.drop_constraint('user_lab_lab_id_fkey', 'user_lab', type_='foreignkey')
    op.create_foreign_key(None, 'user_lab', 'lab', ['lab_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key(None, 'borrowing', 'user', ['user_id'], ['id'], ondelete='CASCADE')
    op.drop_constraint('borrowing_item_id_fkey', 'borrowing', type_='foreignkey')
    op.create_foreign_key(None, 'borrowing', 'item', ['item_id'], ['id'], ondelete='CASCADE')
...
def downgrade():
    ...
    op.drop_constraint(None, 'user_lab', type_='foreignkey')
    ...
    op.drop_constraint(None, 'borrowing', type_='foreignkey')
